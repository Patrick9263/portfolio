...
const Navigation = () => {
	...
	const whiteFilter = 'invert(100%) sepia(100%) saturate(0%) hue-rotate(248deg) brightness(108%) contrast(101%)'
	const imgStyle = {
		width: '30%',
		filter: whiteFilter
	}
	...
	const getImgStyle = (path) => (location.pathname === path ? selectedStyle : imgStyle)
